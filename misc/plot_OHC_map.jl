...
data_dir = "data/output_ocean_mean_temperature"

cases = OrderedDict(
    "SIL_OGCM" => "paper2021_EXP_POP2",
    "SIL_EMOM" => "paper2021_EMOM_EXP_coupled",
    "SIL_MLM"  => "paper2021_MLM_EXP_coupled",
    "SIL_SOM"  => "paper2021_SOM_EXP_coupled",
)
...
Dataset("ocn_zdomain.nc", "r") do ds
...
fig.savefig("graph/ocean_mean_temperature_timeseries.png", dpi=600)
