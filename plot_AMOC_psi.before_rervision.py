...
#ax.clabel(CS, CS.levels, fmt="%d", manual=[(41.2, 3060), (48.62,2020), (41.45, 760), (32.5, 620)], inline_spacing=1, inline=True)
ax.clabel(CS, CS.levels, fmt="%d")
...
fig.savefig("graph/AMOC_psi.png", dpi=600)
plt.show()
